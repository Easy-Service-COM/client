...
const metaConfigs: Record<string, MetaConfig> = {
  ...
  'durashift-oshibka-p1607': {
    title: 'Ошибка P1607 Easytronic: причины и ремонт',
    description:
      'Разбираем ошибку P1607 в роботизированной коробке Easytronic/Durashift: причины появления, симптомы и способы устранения. Ошибка P1607 на роботизированной коробке Easytronic — одна из тех неисправностей, вокруг которых накопилось огромное количество противоречивых советов. Чаще всего владельцу предлагают сразу заменить щётки электромотора, кто-то отправляет менять весь исполнительный механизм, а кто-то советует снимать коробку и менять сцепление. На практике всё не так однозначно.',
